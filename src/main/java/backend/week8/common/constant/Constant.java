...
public class Constant {
	...
	public static final String NOT_FOUND_ADV = "존재하지 않는 광고주 아이디";
	public static final String NOT_FOUND_MEMBER = "존재하지 않는 회원 아이디";
	public static final String NOT_FOUND_DAD_DET = "존재하지 않는 직접광고 상세 아이디";
	public static final String NOT_FOUND_KWD = "존재하지 않는 키워드 아이디";
	...
	public static final String TASK_REQ_ID_EXECUTION_CONTEXT_KEY = "taskReqId";
}
